...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "lemon music bot")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL","rfs_support ")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "RFS_EMPIRE")
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/34c0d7cb37d358434cb27.jpg  ")
