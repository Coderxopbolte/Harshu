...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Vick Music Bot")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL","vick_network")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "THE_NETWORK_HUB_SUPPORT")
